...
import com.zeroli.common.commonutils.LogUtil;
...
public class IRecyclerView extends RecyclerView {
    ...
    public void setRefreshing(boolean refreshing) {
        if (mStatus == STATUS_DEFAULT && refreshing) {
            ...
            this.mIsAutoRefreshing = false;
            LogUtil.loge(TAG, "isRefresh = " + refreshing + " current status = " + mStatus);
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (index < 0) {
                    LogUtil.loge(TAG, "Error processing scroll; pointer index for id " + index + " not found. Did any MotionEvents get skipped?");
                    return false;
                }
                ...
                if (DEBUG) {
                    LogUtil.logi(TAG, "triggerCondition = " + triggerCondition + "; mStatus = " + mStatus + "; dy = " + dy);
                }
                if (triggerCondition) {
    ...
    Animator.AnimatorListener mAnimationListener = new SimpleAnimatorListener() {
        ...
        public void onAnimationEnd(Animator animation) {
            ...
            if (DEBUG) {
                LogUtil.logi(TAG, "onAnimationEnd " + getStatusLog(lastStatus) + " -> " + getStatusLog(mStatus) + " ;refresh view height:" + mRefreshHeaderContainer.getMeasuredHeight());
            }
        }
    };
    ...
    private void printStatusLog() {
        LogUtil.logi(TAG, getStatusLog(mStatus));
    }
